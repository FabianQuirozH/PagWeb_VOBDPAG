...
SECRET_KEY = 'django-insecure--uxfi_xz6c0tnhy53y^36$9lo3b^jzu(m(4_owim_%=f+u08s)'
...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'crispy_bootstrap5',
    'captcha',  # Mantén solo una entrada de 'captcha'
]
...
DATABASES = {
    'default' :{
        ...
        'PORT':'6543',
        'USER':'postgres.tcwfbpkwccyxzwtcefwv',
        'PASSWORD':'Estrellafc_010.',
    }
}
